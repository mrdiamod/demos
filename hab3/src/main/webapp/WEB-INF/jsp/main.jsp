...
<link href="<c:url value="/resources/css/form_style5.css" />" rel="stylesheet">
</head>
<body>
...
<div id="header">
	...
	<div id="logo"><a href="#">Hello ${user.name}!</a>
      <h2><a href="http://www.metamorphozis.com/" id="metamorph">Your password is  ${user.password}!</a></h2>
    </div>
                ...
                <div id="main_bot">
                    ...
                    <div id="left">
                      <h1>Categories</h1>
                        ...
                        <h1 class="tit_right2">Details</h1>	
